...
export const incrementTotalPriceInCart = createAction("[Shopping Cart] Update total price", props<{product : Product}>());
export const decrementTotalPriceInCart = createAction("[Shopping Cart] Update total price", props<{product : Product}>());
